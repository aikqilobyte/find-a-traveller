  ...
  return (
    <div className="grid min-h-screen lg:grid-cols-2">
      <div className="relative hidden lg:flex flex-col justify-end bg-navy p-10 text-navy-foreground">
        ...
        <Link href="/" className="relative z-10 mb-auto flex items-center gap-2 text-lg font-semibold">
      ...
      <div className="flex items-center justify-center p-6 sm:p-10">
        <div className="w-full max-w-sm space-y-6">
          <div className="space-y-1 text-center lg:text-left">
            <Link href="/" className="inline-flex items-center gap-2 text-lg font-semibold text-primary lg:hidden">
